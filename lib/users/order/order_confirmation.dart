...
import 'package:mr_collection/users/fragments/home_fragment_screen.dart';
  ...
  deleteSelectedItemsFromUserCartList(int cartID) async
  {
    try
    {
      ...
      if(res.statusCode == 200)
      {
        ...
        {
          Fluttertoast.showToast(msg: "Produk yang anda order sudah disimpan.");
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Obx(()=> Material(
              elevation: 8,
              color: imageSelectedByte.length > 0 ? Colors.blueAccent : Colors.grey,
              borderRadius: BorderRadius.circular(30),
              child: InkWell(
                onTap: ()
                {
                  ...
                  {
                    Fluttertoast.showToast(msg: "Mohon masukkan screenshot / foto bukti pembayaran.");
                  }
                },
                borderRadius: BorderRadius.circular(30),
                child: const Padding(
