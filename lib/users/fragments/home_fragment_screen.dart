...
import 'package:mr_collection/users/item/item_details_screen.dart';
import 'package:mr_collection/users/item/search_items.dart';
    ...
    return FutureBuilder(
      ...
      builder: (context, AsyncSnapshot<List<Clothes>> dataSnapShot)
      {
        ...
        if(dataSnapShot.data == null)
        {
          return const Center(
            child: Text(
              "Tidak ditemukan produk trending",
            ),
          );
        }
    ...
    return FutureBuilder(
      future: getAllClothItems(),
        builder: (context, AsyncSnapshot<List<Clothes>> dataSnapShot)
        {
          ...
          {
            return const Center(
              child: Text("Kosong, Tidak ada data."),
            );
          }
        }
    );
