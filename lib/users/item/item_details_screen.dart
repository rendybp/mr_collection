...
import 'package:mr_collection/users/cart/cart_list_screen.dart';
import 'package:mr_collection/users/controllers/item_details_controller.dart';
  ...
  addItemToCart() async
  {
    try
    {
      ...
      if(res.statusCode == 200) //from flutter app the connection with api to server - success
      {
        ...
        {
          Fluttertoast.showToast(msg: "Error. Item gagal ditambahkan silahkan coba lagi.");
        }
      }
      else
      {
  ...
  addItemToFavoriteList() async
  {
    try
    {
      ...
      if(res.statusCode == 200) //from flutter app the connection with api to server - success
      {
        ...
        {
          Fluttertoast.showToast(msg: "Barang berhasil disimpan di favorit.");

          validateFavoriteList();
        }
        else
        {
          Fluttertoast.showToast(msg: "Barang tidak disimpan di favorit.");
        }
      }
      else
      {
  ...
  deleteItemFromFavoriteList() async
  {
    try
    {
      ...
      if(res.statusCode == 200) //from flutter app the connection with api to server - success
      {
        ...
        {
          Fluttertoast.showToast(msg: "Barang dihapus dari favorit");

          validateFavoriteList();
        }
        else
        {
          Fluttertoast.showToast(msg: "Barang gagal dihapus dari favorit.");
        }
      }
      else
      {
      ...
      decoration: const BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            offset: Offset(0, -3),
            blurRadius: 6,
            color: Color.fromARGB(255, 138, 181, 255),
          ),
        ],
      ),
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: ()
                        {
                          ...
                          {
                            Fluttertoast.showToast(msg: "Maaf jumlah minimal 1");
                          }
                        },
