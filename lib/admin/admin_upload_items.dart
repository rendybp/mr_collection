...
import 'package:mr_collection/admin/admin_get_all_orders.dart';
...
class _AdminUploadItemsScreenState extends State<AdminUploadItemsScreen>
{
  ...
  uploadItemImage() async
  {
    ...
    requestImgurApi.headers['Authorization'] = "Client-ID " + "3c9f5a535b27193";
  ...
  saveItemInfoToDatabase() async
  {
    ...
    try
    {
      ...
      if(response.statusCode == 200)
      {
        ...
        {
          Fluttertoast.showToast(msg: "Berhasil Mengupload Produk");
        ...
        {
          Fluttertoast.showToast(msg: "Produk gagal diupload. Error, Coba lagi.");
        }
      }
      else
      {
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (val) => val == "" ? "Mohon tulis nama produk" : null,
                          ...
                          TextFormField(
                            ...
                            validator: (val) => val == "" ? "Mohon berikan rating" : null,
                            decoration: InputDecoration(
                              prefixIcon: const Icon(
                                Icons.rate_review,
                                color: Colors.black,
                          ...
                          TextFormField(
                            ...
                            validator: (val) => val == "" ? "Mohon berikan tags" : null,
                            decoration: InputDecoration(
                              prefixIcon: const Icon(
                                Icons.tag,
                                color: Colors.black,
                              ),
                              hintText: "tags1, tags2...",
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(30),
                                borderSide: const BorderSide(
                                  color: Colors.white60,
                          ...
                          TextFormField(
                            ...
                            validator: (val) => val == "" ? "Mohon berikan harga" : null,
                            decoration: InputDecoration(
                              prefixIcon: const Icon(
                          ...
                          TextFormField(
                            ...
                            validator: (val) => val == "" ? "Mohon berikan ukuran" : null,
                            decoration: InputDecoration(
                              prefixIcon: const Icon(
                                Icons.picture_in_picture,
                                color: Colors.black,
                              ),
                              hintText: "ukuran1, ukuran2...",
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(30),
                                borderSide: const BorderSide(
                                  color: Colors.white60,
                          ...
                          TextFormField(
                            ...
                            validator: (val) => val == "" ? "Mohon berikan variasi warna" : null,
                            decoration: InputDecoration(
                              prefixIcon: const Icon(
                                Icons.color_lens,
                                color: Colors.black,
                              ),
                              hintText: "warna1, warna2...",
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(30),
                                borderSide: const BorderSide(
                                  color: Colors.white60,
                          ...
                          TextFormField(
                            ...
                            validator: (val) => val == "" ? "Mohon berikan deskripsi produk" : null,
                            decoration: InputDecoration(
                              prefixIcon: const Icon(
                                Icons.description,
                                color: Colors.black,
